...
%
temp_month_data=['soda3.15.2_5dy_ocean_reg_2013_09_26.nc'];
salt_month_data=['soda3.15.2_5dy_ocean_reg_2013_09_26.nc'];
%
%
...
%
  for obcndx=1:4
	...
	suffix='_west';
      ...
      disp('  Temperature...')
      bry_interp_soda(Zbryname,lon,lat,temp_month_data,...
               'temp',['temp',suffix],obcndx,Roa);
      disp('  Salinity...')
      bry_interp_soda(Zbryname,lon,lat,salt_month_data,...
               'salt',['salt',suffix],obcndx,Roa);       
    end
  end
end
%
