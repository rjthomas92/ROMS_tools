...
lonmax =  145;   % Maximum longitude [degree east]
...
%
grdname  = [ROMS_files_dir,'roms_grd4.nc'];
frcname  = [ROMS_files_dir,'roms_frc.nc'];
blkname  = [ROMS_files_dir,'roms_blk.nc'];
clmname  = [ROMS_files_dir,'roms_clm.nc'];
bryname  = [ROMS_files_dir,'roms_bry4.nc'];
ininame  = [ROMS_files_dir,'roms_ini4.nc'];
...
%
obc = [1 1 1 0]; % open boundaries (1=open , [S E N W])
%
...
%
woa_dir=[DATADIR,'Preprocessing_tools/WOA2009/'];
%
...
Mmin          = 7;             % first forcing month
Mmax          = 11;             % last  forcing month
%
Dmin          = 2;             % Day of initialization
...
elseif NCEP_version  == 3;
  My_NCEP_dir  = ['/home/rhysjt/Work/WRFrun/WPS/DATA/ncep/','cdas2018/'];
end
...
OGCM_dir    = ['/home/rhysjt/Work/ROMSrun/Roms_tools/Preprocessing_tools'];
